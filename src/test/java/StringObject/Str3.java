...
public class Str3 {
    ...
    //If this password consist of only lower case letters print "invalid response all lower case".
    //If this password consist of only upper case letters print "invalid response all upper case".
    //  If this password consist of both upper and  lower case letters print "valid password.".
